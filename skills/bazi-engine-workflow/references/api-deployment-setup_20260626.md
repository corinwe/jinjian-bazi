...
```bash
# 开发模式
cd /root/bazi-platform && ./run.sh
# 或手动
PYTHONPATH=/root/bazi-platform:$PYTHONPATH python3 -m uvicorn api.main:app --host 0.0.0.0 --port 8000 --reload
...
- 数据库路径：`/root/bazi-platform/database/bazi.db`
