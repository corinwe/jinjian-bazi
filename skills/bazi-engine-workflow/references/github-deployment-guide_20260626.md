...
export PYTHONPATH=/root/.hermes/profiles/jinjian-zhenren/projects/bazi-platform:$PYTHONPATH
...
```bash
docker build -t jinjian-bazi /root/.hermes/profiles/jinjian-zhenren/projects/bazi-platform
