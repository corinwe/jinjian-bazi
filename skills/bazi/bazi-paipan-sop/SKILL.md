...
### Step 4.2 — 格局判定规则（写§2前先过此规则·含主格+辅格双体系）

> 🚨 **格局判定是报告最容易被质疑的环节。必须严格按原始理论两步走：先定主格，再定辅格。**
>
> **第一步：主格判定（月令定格局——原始规则原文）**
> ```
> 规则来源：九龙道长素材「月令的本气、中气和余气在本命局的天干...一旦透出，代表格局形成。
>          除了比肩和劫财不入格之外，其他的有八大正格...没有透干叫杂气格，随着大运不断改变格局」
>
> 操作流程：
>   Step 1 — 月令是什么？→ 月支的本气/中气/余气各是什么十神？
>   Step 2 — 月令藏干有没有透出天干？
>     ├─ 月令本气是天干十神之一 → 以本气定格局 ✅（入正八格）
>     ├─ 本气不透，中气/余气透出 → 以透出者定格局 ✅（入正八格）
>     └─ 本气/中气/余气全部不透天干 → **杂气格** ⚠️（不入正八格）
>
> 例：辛金日主，月令未土（藏己偏印/丁七杀/乙偏财），天干庚癸辛辛
>   → 己/丁/乙全部没有透出天干
>   → 主格 = **杂气格**
>   → ❌ 不是偏印格，不是食神格，不是食神配印——月令藏干不透就不入正八格
> ```
>
> **第二步：辅格判定（原局特征+大运变格——九龙道长体系特有三层）**
> ```
> 规则来源：九龙道长素材原文——
>   「杂气格的人生追求会变来变去」
>   「在这个大运他地支有木了，天干的财在地支透出了，
>     那这个大运满脑子都是想着搞钱，就变成正财格了」
>   「换了大运，地支的食伤在天干透出了，
>     就不想着赚钱了，满脑子吃喝玩乐」
>
> 操作流程（杂气格专有）：
>
>   Layer A — 原局能量第二/第三（月令排第一，日支排第二，时柱排第三）
>     ├─ 月干是什么十神？→ 影响核心性格（食神=理性/伤官=锐利/偏印=深度...）
>     ├─ 日支自坐是什么十神？→ 影响脾气（食神=急/七杀=暴/比劫=犟/正官=好）
>     └─ 时柱是什么十神？→ 影响晚年/子女
>
>   Layer B — 大运变格（每步大运的天干决定了这10年的格局倾向）
>     第一步大运的天干是什么十神 → 这10年偏什么格局
>     第二步大运的天干是什么十神 → 下个10年格局转换
>     ...
>     例：甲申运(正财) → 正财格倾向 → 满脑子搞钱
>         乙酉运(偏财) → 偏财格倾向
>         丙戌运(正官) → 正官格倾向
>         丁亥运(七杀) → 七杀格/杀印相生
>         戊子运(偏印-现行) → 偏印格倾向 → 想得多做得少
>         己丑运(偏印) → 偏印格
>         庚寅运(劫财) → 劫财格倾向 → 合作
>         辛卯运(比肩) → 比肩格倾向
>
>   Layer C — 综合定名：主格 + 原局特征 + 大运变格（如适用）
>     例：杂气格·食神透干·自坐伤官 或 杂气格·偏印透干·自坐食神
> ```
>
> **写§2前必须过以下流程：**
> ```
...
> □ 月令藏干有没有透出天干？→ 定主格
> □ 如为杂气格 → 月干十神是什么？日支自坐十神是什么？→ 定辅格
> □ 大运天干分别是什么十神？→ 标注大运变格
> □ 最终格局名：主格+辅格（如：杂气格·食神透干）
> ```
