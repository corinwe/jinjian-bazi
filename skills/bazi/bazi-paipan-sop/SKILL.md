...
> 
> ⚠️ **新增通用分析逻辑**（2026-07-22）：在格局判定后、写报告前，必须加载 `bazi-foundation-analysis` 的 §37（12项通用分析逻辑）。含：从杀格判定三条件、家庭合参、创业合参、单动vs双动机制、置业规律、巳字应期落空提醒。详见 `references/实证反推_12项体系化修正_20260722.md` 和 `references/四份专业文档精读_体系化提升_20260722.md`。
