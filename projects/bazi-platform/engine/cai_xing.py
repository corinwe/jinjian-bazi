...
from constants import CANG_GAN_RATIO, TIAN_GAN_WU_XING, WU_XING_KE, BaZi, CaiXingDetail, Pillar
...
def compute_cai_xing(bazi: BaZi) -> CaiXingDetail:
    ...
    detail.total = round(
        nian_gan_score
        + month_gan_score
        + detail.nian_zhi_score
        + yue_ling_cai
        + detail.ri_zhi_score
        + detail.shi_gan_score
        + detail.shi_zhi_score,
        1,
    )
