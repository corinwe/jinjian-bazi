...
def run_pipeline(bazi: BaZi, birth_year: int = 1980, birth_month_lunar: int = 1, qi_yun_days: float = 1.1) -> dict:
    """
    执行完整流水线
    ...
    result = {
        ...
        "shi_shen": {
            "tian_gan": [{"position": s["position"], "gan": s["gan"], "shi_shen": s["shi_shen"]} for s in shi_shen_dry],
            "cang_gan": [
                {"position": s["position"], "zhi": s["zhi"], "cang_gan": s["cang_gan"], "shi_shen": s["shi_shen"]}
        ...
        "xi_yong_shen": {"xi_yong_wu_xing": xi_yong, "ji_shen_wu_xing": ji_shen, "tiao_hou_yong_shen": tiao_hou},
        "da_yun": {
        ...
        "dimensions": {
            dim_name: {"base": ds.base, "da_yun_bonus": ds.da_yun_bonus, "total": ds.total}
...
if __name__ == "__main__":
    ...
    for name, yg, yz, mg, mz, dg, dz, hg, hz, gender, byear, blunar in test_cases:
        result = run_pipeline_from_stems(yg, yz, mg, mz, dg, dz, hg, hz, gender, byear, blunar)
        print_report(result)
