...
def _get_pei_ou_xing(ri_zhu: str, gender: str,
                      bazi_gans: list[str], bazi_zhis: list[str]) -> dict:
    """
    配偶星定位
...
def _find_shi_shen_in_bazi(target_ss: str, ri_zhu: str,
                            bazi_gans: list[str], bazi_zhis: list[str]) -> dict:
    """在八字中找到指定十神的位置"""
...
def _calculate_marriage_windows(
    ri_zhi: str, ri_zhu: str, gender: str,
    bazi_gans: list[str], shen_label: str,
    xi_yong: list[str],
...
def _calculate_marriage_quality(ri_zhi: str, ri_zhu: str, gender: str,
                                 shen_label: str, shen_score: float,
                                 pei_ou: dict, xi_yong: list[str]) -> dict:
    """婚姻质量综合评分"""
    score = 5.0  # 基准分
...
def analyze_marriage(
    ...
    # ③ 结婚窗口
    windows = _calculate_marriage_windows(ri_zhi, ri_zhu, gender, bazi_gans,
                                           shen_label, xi_yong,
                                           da_yun_gans, da_yun_zhis, da_yun_start_ages)
    
    # ④ 婚姻质量评分
    quality = _calculate_marriage_quality(ri_zhi, ri_zhu, gender, shen_label,
                                           shen_score, pei_ou, xi_yong)
