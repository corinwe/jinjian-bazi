...
from constants import (
    ...
    DI_ZHI_CANG_GAN, CANG_GAN_RATIO,
    WU_XING_SHENG, WU_XING_KE,
    BaZi, Pillar,
)
from xing_chong_he_hua import (
    check_all_relations, NENG_LIANG,
)
...
if __name__ == "__main__":
    ...
    print(f"日主能量: 生扶{profile['ri_zhu_energy']['sheng_fu_energy']} vs 克泄{profile['ri_zhu_energy']['ke_xie_energy']}")
