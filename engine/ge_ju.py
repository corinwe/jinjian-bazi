...
from constants import (
    TIAN_GAN, TIAN_GAN_WU_XING, TIAN_GAN_YIN_YANG,
    DI_ZHI, DI_ZHI_WU_XING, DI_ZHI_CANG_GAN,
    WU_XING_SHENG, WU_XING_KE,
    BaZi, Pillar,
)
from shi_shen import (
    get_shi_shen_for_gan, get_shi_shen_for_cang_gan,
    is_tou_gan, get_shi_shen_all_dry
)
...
def determine_ge_ju(bazi: BaZi) -> tuple[str, str]:
    ...
    # 官杀混杂
    has_guan = is_tou_gan("", bazi, "正官") or "正官" in [get_shi_shen_for_gan(p.gan, ri_zhu) for p in [bazi.year, bazi.month, bazi.day, bazi.hour]]
    has_sha = is_tou_gan("", bazi, "七杀") or "七杀" in [get_shi_shen_for_gan(p.gan, ri_zhu) for p in [bazi.year, bazi.month, bazi.day, bazi.hour]]
...
# ── 调候用神表（按出生月份）──
TIAO_HOU_YONG_SHEN = {
    "甲": {1: "丙", 2: "丙", 3: "庚", 4: "庚", 5: "壬", 6: "壬",
           7: "壬", 8: "癸", 9: "庚", 10: "庚", 11: "丙", 12: "丙"},
    "乙": {1: "丙", 2: "丙", 3: "丙", 4: "癸", 5: "壬", 6: "壬",
           7: "癸", 8: "癸", 9: "癸", 10: "癸", 11: "丙", 12: "丙"},
    "丙": {1: "壬", 2: "壬", 3: "壬", 4: "壬", 5: "壬", 6: "壬",
           7: "壬", 8: "壬", 9: "甲", 10: "甲", 11: "壬", 12: "壬"},
    "丁": {1: "甲", 2: "甲", 3: "甲", 4: "甲", 5: "壬", 6: "壬",
           7: "甲", 8: "甲", 9: "甲", 10: "甲", 11: "甲", 12: "甲"},
    "戊": {1: "丙", 2: "丙", 3: "丙", 4: "丙", 5: "壬", 6: "壬",
           7: "庚", 8: "庚", 9: "丙", 10: "甲", 11: "丙", 12: "丙"},
    "己": {1: "丙", 2: "丙", 3: "甲", 4: "癸", 5: "壬", 6: "壬",
           7: "癸", 8: "癸", 9: "癸", 10: "丙", 11: "丙", 12: "丙"},
    "庚": {1: "丁", 2: "甲", 3: "甲", 4: "壬", 5: "癸", 6: "壬",
           7: "壬", 8: "癸", 9: "甲", 10: "甲", 11: "丁", 12: "丙"},
    "辛": {1: "丙", 2: "丙", 3: "甲", 4: "壬", 5: "壬", 6: "壬",
           7: "壬", 8: "壬", 9: "壬", 10: "壬", 11: "丙", 12: "丙"},
    "壬": {1: "戊", 2: "戊", 3: "甲", 4: "壬", 5: "庚", 6: "庚",
           7: "戊", 8: "甲", 9: "甲", 10: "甲", 11: "戊", 12: "戊"},
    "癸": {1: "丙", 2: "丙", 3: "丙", 4: "庚", 5: "庚", 6: "庚",
           7: "壬", 8: "壬", 9: "甲", 10: "壬", 11: "丙", 12: "丙"},
}
