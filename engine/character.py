...
RI_ZHU_CHARACTER = {
    "甲": {
        "base": "阳木·参天大树",
        "traits": ["正直", "进取", "有领导力", "固执"],
        "desc": "性格刚直、有担当，像大树一样顶天立地。目标感强，不轻易低头。",
    },
    "乙": {
        "base": "阴木·花草藤蔓",
        "traits": ["柔韧", "适应力强", "细腻", "固执"],
...
SHI_SHEN_CHARACTER = {
    "正印": {
        "label": "学识型",
        "traits": ["稳重", "好学", "守规矩", "传统"],
        "positive": "学习能力强，有文化底蕴",
        "negative": "过于保守，缺乏突破",
    },
    "偏印": {
        "label": "研究型",
        "traits": ["独特", "深度", "孤僻", "创新"],
        "positive": "思维独特有深度，擅长研究",
        "negative": "孤僻不合群，钻牛角尖",
    },
    "正官": {
        "label": "规则型",
    ...
    "伤官": {
        ...
        "traits": ["聪明", "有才华", "叛逆", "高傲"],
        "positive": "才华横溢，创新能力强",
        "negative": "叛逆高傲，人际关系紧张",
    },
}


def analyze_character(
    ri_zhu: str, bazi_gans: list[str], shen_label: str, shen_score: float, di_zhi_summary: str, shen_sha_summary: str
) -> dict:
    """
    完整性格分析
    """
...
if __name__ == "__main__":
    ...
    result = analyze_character(
        "甲", ["庚", "辛", "甲", "丙"], "身弱", 12.0, "冲: 申寅冲 | 刑: 寅巳申三刑", "文昌: 甲→巳 | 天乙: 甲→丑,甲→未"
    )
