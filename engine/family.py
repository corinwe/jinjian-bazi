...
def analyze_nian_yue(
    ...
    return {
        "nian_zhu": {"gan": year_gan, "zhi": year_zhi, "shi_shen": year_shi_shen, "meaning": year_meaning},
        "yue_zhu": {"gan": month_gan, "zhi": month_zhi, "shi_shen": month_shi_shen, "meaning": month_meaning},
        ...
        "day_pillar": {"detail": "日支为配偶宫，由§12婚姻分析详细展开"},
        "hour_pillar": {"detail": "时柱为子女宫，由§13子女分析详细展开"},
